...
public class Auto_Specimen extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action autoSequence = drive.actionBuilder(new Pose2d(new Vector2d(6,-64),-Math.PI/2))
                ...
                .afterTime(1.6,AutoSeq.SamplePickForSpecimen(arm,slider))
                .splineToLinearHeading(new Pose2d(new Vector2d(27.5,-33),Math.PI/12),Math.PI/4)
                ...
                .afterTime(0.9,AutoSeq.SamplePickForSpecimen(arm,slider))
                .strafeToLinearHeading(new Vector2d(37,-33),Math.PI/12)
                .afterTime(0.6,AutoSeq.SampleDropObsZone(arm,slider))
